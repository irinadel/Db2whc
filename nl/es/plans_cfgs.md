...
Ver todos los planes {{site.data.keyword.dashdbshort_notm}} disponibles en el catálogo  [{{site.data.keyword.Bluemix}} ](https://console.bluemix.net/catalog/services/db2-warehouse){:new_window}.
