...
5. Entrez les informations de connexion :
   ...
   Lorsque vous sélectionnez **Data Service**, vos services de données {{site.data.keyword.Bluemix_notm}} existants apparaissent dans la liste **Instance de service**.
