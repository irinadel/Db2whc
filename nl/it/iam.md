...
* L'istruzione CLP CONNECT può contenere uno dei seguenti:
    ...
    **ID IBM/password**
    ...
    Per ulteriori dettagli sulla connessione a un server database con CLP, consulta: [CONNECT (type 2) statement](https://www.ibm.com/support/knowledgecenter/SS6NHC/com.ibm.swg.im.dashdb.sql.ref.doc/doc/r0000908.html){:external}. 
...
* L'istruzione CLPPLUS CONNECT può contenere uno dei seguenti:
    ...
    **ID IBM/password**
    ...
    Per ulteriori dettagli sulla connessione agli alias DSN con CLPPLUS, vedi: [DSN aliases in CLPPlus](https://www.ibm.com/support/knowledgecenter/SS6NHC/com.ibm.swg.im.dashdb.clpplus.doc/doc/c0057148.html){:external}.
...
Per ulteriori dettagli sull'API del tuo servizio, vedi: [{{site.data.keyword.dashdbshort_notm}} REST API](http://ibm.biz/db2whc_api){:external}.
